            ...
            <div class="max-w-6xl min-h-80 rounded-lg bg-white dark:bg-gray-800 p-6 shadow-md">
                ...
                <form action="../../api/adminApi.php" method="post" class="w-full mt-5">
                    <div class="mb-5">
                        ...
                        <input type="name" id="name" name="name" class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-blue-600 focus:border-blue-600 block w-full px-3 py-2.5 shadow-xs placeholder:text-body" value="<?= $name ?>" required />
                    </div>
                    <div class="mb-5">
