...
<div class="min-h-screen">
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:min-h-screen ">
        <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            <img class="w-10 h-10 mr-2" src="../assets/imgs/lib-logo-no-bg.png" alt="logo">
            BASC Library    
        </a>
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            ...
            <form action="../api/auth.php" method="post" class="p-8">
                    <div class="flex flex-col mb-4 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg text-gray-800 dark:text-white" >
